...
>
    {{-- Nomor Gigi --}}
    <span class="text-[10px] sm:text-xs font-semibold tracking-wider transition-all duration-300 group-hover:text-primary group-hover:scale-110 {{ $isDeciduous ? 'text-info/80' : 'text-base-content/60' }}">
        {{ $number }}
    </span>
    ...
    <div class="relative w-10 h-10 sm:w-[46px] sm:h-[46px] transition-transform duration-300 group-hover:scale-[1.05]">
        <svg fill="none" viewBox="0 0 100 100" class="w-full h-full tooth-diagram select-none overflow-visible drop-shadow-sm">
            ...
            {{-- Nomor Gigi di Tengah (Kelihatan samar) --}}
            <text x="50" y="52" 
                  text-anchor="middle" 
                  ...
                  font-weight="bold"
                  fill="currentColor" 
                  class="text-base-content/20 font-mono pointer-events-none select-none">
                {{ $number }}
            </text>
